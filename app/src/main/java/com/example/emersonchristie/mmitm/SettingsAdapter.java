...
public class SettingsAdapter extends ArrayAdapter<UserData> implements View.OnClickListener{
    ...
    public SettingsAdapter(ArrayList<UserData> data, Context context) {
        super(context, R.layout.settings_layout, data);
        this.dataSet = data;
